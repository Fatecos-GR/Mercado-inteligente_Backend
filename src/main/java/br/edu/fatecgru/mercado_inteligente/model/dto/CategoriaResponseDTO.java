...
public class CategoriaResponseDTO {
	...
	@Schema(description = "ID da categoria", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
	private Long id;

	@Schema(description = "Nome da categoria", example = "Alimentos", requiredMode = Schema.RequiredMode.REQUIRED)
	private String nome;

	@Schema(description = "Descrição da categoria", example = "Produtos alimentícios em geral")
