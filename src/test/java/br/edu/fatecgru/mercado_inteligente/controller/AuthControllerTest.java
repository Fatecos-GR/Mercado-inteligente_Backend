...
class AuthControllerTest {
    ...
    void registrarUsuarioValido() throws Exception {
        String json = "{\"nome\": \"João\", \"sobrenome\": \"Silva\", \"email\": \"joao.unico@email.com\", \"senha\": \"senha123\", \"telefone\": \"11999999999\"}";
    ...
    void registrarEmailDuplicado() throws Exception {
        String json = "{\"nome\": \"Maria\", \"sobrenome\": \"Teste\", \"email\": \"duplicado@email.com\", \"senha\": \"senha123\", \"telefone\": \"11999999999\"}";
    ...
    void loginSenhaErrada() throws Exception {
        String registroJson = "{\"nome\": \"Jose\", \"sobrenome\": \"Silva\", \"email\": \"jose@email.com\", \"senha\": \"senha123\", \"telefone\": \"11999999999\"}";
    ...
    void forcarRoleCliente() throws Exception {
        ...
        String jsonHacker = "{\"nome\": \"Hacker\", \"sobrenome\": \"Malicioso\", \"email\": \"hacker@email.com\", \"senha\": \"senha123\", \"telefone\": \"11999999999\", \"tipo\": \"ADMIN\"}";
        ...
        // Agora tentamos fazer login e ver se o token gerado permite acesso de Admin (deve falhar)
        String loginJson = "{\"email\": \"hacker@email.com\", \"senha\": \"senha123\"}";
