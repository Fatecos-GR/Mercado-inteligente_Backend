...
public class MarcaServiceIntegridadeTest {
    ...
    void delete_Sucesso_ComCascata_QuandoProdutosNaoEstaoAtivos() {
        ...
        verify(produtoService).deleteProduto(10L);
        verify(marcaRepository).deleteById(marcaId);
    }
    ...
    void delete_Erro_QuandoAlgumProdutoEstaEmCarrinhoAtivo() {
        ...
        // Simula que o produtoService bloqueou a exclusão do produto por estar em carrinho ativo
        doThrow(new IllegalStateException("Erro de integridade")).when(produtoService).deleteProduto(10L);
