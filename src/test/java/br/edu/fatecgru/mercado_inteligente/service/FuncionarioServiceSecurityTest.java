...
public class FuncionarioServiceSecurityTest {
    ...
    void cadastrar_DeveLancarAccessDenied_QuandoNaoAdminTentaCriarAdmin() {
        ...
        // Simula usuário logado como ROLE_ESTOQUISTA usando doReturn para evitar problemas de tipos genéricos
        List<SimpleGrantedAuthority> authorities = Collections.singletonList(new SimpleGrantedAuthority("ROLE_ESTOQUISTA"));
